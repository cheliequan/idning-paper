...
void evtag_marshal_ping(struct evbuffer *, ev_uint32_t, const struct ping *);
int evtag_unmarshal_ping(struct evbuffer *, ev_uint32_t, struct ping *);
...
int evtag_unmarshal_machine(struct evbuffer *, ev_uint32_t, struct machine *);
...
void evtag_marshal_pong(struct evbuffer *, ev_uint32_t, const struct pong *);
int evtag_unmarshal_pong(struct evbuffer *, ev_uint32_t, struct pong *);
...
struct file_stat_access_ {
    ...
    ev_uint32_t *(*pos_arr_add) (struct file_stat * msg,
...
ev_uint32_t *file_stat_pos_arr_add(struct file_stat *msg,
                                   const ev_uint32_t value);
...
struct stat_request_access_ {
    ...
    ev_uint64_t *(*ino_arr_add) (struct stat_request * msg,
...
ev_uint64_t *stat_request_ino_arr_add(struct stat_request *msg,
                                      const ev_uint64_t value);
/* --- stat_request done --- */
...
struct stat_response_access_ {
    int (*stat_arr_assign) (struct stat_response *, int,
                            const struct file_stat *);
...
int evtag_unmarshal_stat_response(struct evbuffer *, ev_uint32_t,
                                  struct stat_response *);
int stat_response_stat_arr_assign(struct stat_response *, int,
                                  const struct file_stat *);
int stat_response_stat_arr_get(struct stat_response *, int,
                               struct file_stat **);
...
struct setattr_request_access_ {
    int (*stat_arr_assign) (struct setattr_request *, int,
                            const struct file_stat *);
...
int evtag_unmarshal_setattr_request(struct evbuffer *, ev_uint32_t,
                                    struct setattr_request *);
int setattr_request_stat_arr_assign(struct setattr_request *, int,
                                    const struct file_stat *);
int setattr_request_stat_arr_get(struct setattr_request *, int,
                                 struct file_stat **);
...
struct setattr_response_access_ {
    int (*stat_arr_assign) (struct setattr_response *, int,
                            const struct file_stat *);
...
void setattr_response_marshal(struct evbuffer *,
...
int evtag_unmarshal_setattr_response(struct evbuffer *, ev_uint32_t,
                                     struct setattr_response *);
int setattr_response_stat_arr_assign(struct setattr_response *, int,
                                     const struct file_stat *);
int setattr_response_stat_arr_get(struct setattr_response *, int,
                                  struct file_stat **);
...
struct ls_request_access_ {
    ...
    ev_uint64_t *(*ino_arr_add) (struct ls_request * msg,
                                 const ev_uint64_t value);
};
...
ev_uint64_t *ls_request_ino_arr_add(struct ls_request *msg,
                                    const ev_uint64_t value);
/* --- ls_request done --- */
...
struct ls_response_access_ {
    int (*stat_arr_assign) (struct ls_response *, int,
                            const struct file_stat *);
...
int evtag_unmarshal_ls_response(struct evbuffer *, ev_uint32_t,
                                struct ls_response *);
int ls_response_stat_arr_assign(struct ls_response *, int,
                                const struct file_stat *);
...
struct mknod_response_access_ {
    int (*stat_arr_assign) (struct mknod_response *, int,
                            const struct file_stat *);
...
int evtag_unmarshal_mknod_response(struct evbuffer *, ev_uint32_t,
                                   struct mknod_response *);
int mknod_response_stat_arr_assign(struct mknod_response *, int,
                                   const struct file_stat *);
int mknod_response_stat_arr_get(struct mknod_response *, int,
                                struct file_stat **);
...
int evtag_unmarshal_symlink_request(struct evbuffer *, ev_uint32_t,
                                    struct symlink_request *);
int symlink_request_parent_ino_assign(struct symlink_request *,
                                      const ev_uint64_t);
...
void symlink_response_marshal(struct evbuffer *,
...
int evtag_unmarshal_symlink_response(struct evbuffer *, ev_uint32_t,
                                     struct symlink_response *);
int symlink_response_stat_assign(struct symlink_response *,
                                 const struct file_stat *);
...
void readlink_request_marshal(struct evbuffer *,
...
void readlink_response_marshal(struct evbuffer *,
...
int evtag_unmarshal_lookup_request(struct evbuffer *, ev_uint32_t,
                                   struct lookup_request *);
int lookup_request_parent_ino_assign(struct lookup_request *,
                                     const ev_uint64_t);
...
struct lookup_response_access_ {
    int (*stat_arr_assign) (struct lookup_response *, int,
                            const struct file_stat *);
...
int evtag_unmarshal_lookup_response(struct evbuffer *, ev_uint32_t,
                                    struct lookup_response *);
int lookup_response_stat_arr_assign(struct lookup_response *, int,
                                    const struct file_stat *);
int lookup_response_stat_arr_get(struct lookup_response *, int,
                                 struct file_stat **);
...
int evtag_unmarshal_unlink_request(struct evbuffer *, ev_uint32_t,
                                   struct unlink_request *);
int unlink_request_parent_ino_assign(struct unlink_request *,
                                     const ev_uint64_t);
...
int evtag_unmarshal_statfs_response(struct evbuffer *, ev_uint32_t,
                                    struct statfs_response *);
int statfs_response_total_space_assign(struct statfs_response *,
                                       const ev_uint32_t);
int statfs_response_total_space_get(struct statfs_response *, ev_uint32_t *);
int statfs_response_avail_space_assign(struct statfs_response *,
                                       const ev_uint32_t);
int statfs_response_avail_space_get(struct statfs_response *, ev_uint32_t *);
int statfs_response_inode_cnt_assign(struct statfs_response *,
                                     const ev_uint32_t);
...
struct mkfs_request_access_ {
    ...
    ev_uint32_t *(*pos_arr_add) (struct mkfs_request * msg,
                                 const ev_uint32_t value);
};
...
ev_uint32_t *mkfs_request_pos_arr_add(struct mkfs_request *msg,
                                      const ev_uint32_t value);
/* --- mkfs_request done --- */
